...
exports.postSignup = (req, res, next) => {
  ...
  .then(result => {
       res.render('auth/psuedo-email', {
        path: '/psuedo-email',
        pageTitle: 'PSUEDO EMAIL: Confiration Email',
  ...
  crypto.randomBytes(32, (err, buffer) => {
    ...
    User.findOne({ email: req.body.email })
      ...
      .then(result => {
        ...
        res.render('auth/psuedo-email', {
          path: '/psuedo-email',
          pageTitle: 'PSUEDO EMAIL: Password Reset',
          pageContent: 'You requested a password reset',
          pageLink: `http://localhost:3500/reset/${token}`,
